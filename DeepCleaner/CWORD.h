...
class CWORD : public COleDispatchDriver
{
public:
	CWORD(){} // 调用 COleDispatchDriver 默认构造函数
	CWORD(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CWORD(const CWORD& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
